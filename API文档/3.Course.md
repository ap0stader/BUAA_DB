...
```javascript
{
  "course_teacher_id": "{course_teacher_id}", // 申报课程的老师
...
**注：上传成功之后，应能用`https://ecs.1230123.xyz:20080/static/upload/{filename}`访问。**
    ...
    "courses": [
      {
        ...
        "course_teacher_name": "{course_teacher_name}" | null, // 申报教师姓名
    ...
    "curriculums": [
      {
        ...
        "curriculum_semester_id": curriculum_semester_id, // 教学班所在的学期编号
        "curriculum_semester_name": curriculum_semester_name, // 教学班所在的学期的名称
        "curriculum_course_id": "{curriculum_course_id}", // 教学班对应的课程编号
        "course_name": "{course_name}", // 教学班对应的课程名称
        "course_type": 0 | 1 | 2 | 3 | 4, // 教学班对应的课程分类，依次对应必修课、选修课、通识课、体育课、科研课
        "course_credit": course_credit, // 教学班对应的课程学分
        "course_hours": course_hours, // 教学班对应的课程学时
        "curriculum_teacher_id": "{curriculum_teacher_id}", // 开设教学班的教师工号
        "curriculum_teacher_name": "{curriculum_teacher_name}", // 开设教学班的教师姓名
        "curriculum_teacher_department_id": curriculum_teacher_department_id, // 开设教学班的教师所属的院系
        "curriculum_capacity": curriculum_capacity, // 教学班容量
        "curriculum_choice_number": curriculum_choice_number, // 教学班预选人数
        "curriculum_attendance_number": curriculum_attendance_number, // 教学班中选人数
        "curriculum_info": "{curriculum_info}", // 教学班的额外信息
...
**执行成功后，数据库缓存的`curriculum_utilization_string`应置位NULL（不是空字符串）**
