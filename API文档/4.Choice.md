...
**注：添加选课审计信息。若抽签中选，审计类型为2；若抽签落选，审计类型为3。操作人均为superadmin。**
...
| semester_id | Integer   | 需要获取的选课信息的学期     |
    ...
    "choices": [
      {
        ...
        "choice_introduction": "{choice_introduction}" | null, // 学生的描述
      },
      // ......
    ]
  }
